...
-- Forward declaration: Wall systems are defined below this point, but
-- earlier systems reference Wall at runtime (never at parse time).
local Wall
...
--======================================================================
local GapZip = { Active = false, Token = 0 }
...
RunService:BindToRenderStep("SpideyCamera_v3", Enum.RenderPriority.Camera.Value + 1, function(dt)
	...
	if Sling.Phase == 2 then
		...
		targetFOV = math.clamp(
			CONFIG.FOVBase + (speed / CONFIG.FOVSpeedDivisor) * CONFIG.FOVGain,
...
print("[SPIDEY ENGINE v3.0] Loaded successfully — press RightShift to open the control panel.")
